...
export class LoginComponent implements OnInit {
  ...
  constructor(private usersUserservice: UsersService, private authService: AuthService, private router: Router, private route: ActivatedRoute) {
  }
  ...
  onSubmit() {
    ...
    this.usersUserservice.getUserByEmail(formData.email)
      .subscribe((user: User) => {
        if (user) {
